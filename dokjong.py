...
async def on_message(message):
    ...
    if message.content.startswith("!도움말기록"):
        f = open("도움말.txt", "w", encoding='cp949')
        f.write("RED CHANEL 곡예 코카콜라 감자포차 스타위한스타 zombie")
        f.close()

    if message.content.startswith("!도움말"):
        f = open("도움말.txt", encoding='cp949')
        await message.channel.send(f.read())
        f.close()

    if message.content.startswith("!이벤트기록"):
        f = open("이벤트.txt", "w", encoding='cp949')
        f.write("준비중")
        f.close()

    if message.content.startswith("!이벤트"):
        f = open("이벤트.txt", encoding='cp949')
        await message.channel.send(f.read())
        f.close()

    if message.content.startswith("!랭킹기록"):
        f = open("랭킹.txt", "w", encoding='cp949')
        f.write("준비중")
        f.close()

    if message.content.startswith("!랭킹"):
        f = open("랭킹.txt", encoding='cp949')
        await message.channel.send(f.read())
        f.close()
